...
public class GroupTestData {
	...
	public static Pair<HashMap<Integer, Group>, HashMap<Group, Integer>> createGroups() {
		...
		Lecturer lect19 = new Lecturer(1, "GlybovetsA", new ArrayList<Period>());
		...
		GroupCode groupCode82 = new GroupCode(13, "ICCD", "lect", lect15, 11);
		...
		GroupCode groupCode95 = new GroupCode(1, "PObc", "lect", lect5, 11);
		GroupCode groupCode96 = new GroupCode(1, "PObc", "prakt", lect5, 11);
		GroupCode groupCode97 = new GroupCode(1, "PVMM", "lect", lect7, 11);
		GroupCode groupCode98 = new GroupCode(1, "PVMM", "prakt", lect7, 11);
		GroupCode groupCode99 = new GroupCode(1, "POS", "lect", lect19, 11);
		GroupCode groupCode100 = new GroupCode(1, "POS", "prakt", lect19, 11);
		...
		Group group1 = new Group(1, groupCode1, 0, "IUST-2");
		Group group2 = new Group(2, groupCode2, 1, "IUST-2");
		Group group3 = new Group(3, groupCode3, 0, "IUST-2");
		Group group4 = new Group(4, groupCode4, 1, "IUST-2");
		Group group5 = new Group(5, groupCode5, 0, "IUST-2");
		Group group6 = new Group(6, groupCode6, 1, "IUST-2");
		Group group7 = new Group(7, groupCode7, 0, "IUST-2");
		Group group8 = new Group(8, groupCode8, 1, "IUST-2");
		Group group9 = new Group(9, groupCode9, 0, "IUST-2");
		Group group10 = new Group(10, groupCode10, 1, "IUST-2");
		Group group11 = new Group(11, groupCode11, 0, "IUST-2");
		Group group12 = new Group(12, groupCode12, 1, "IUST-2");
		Group group13 = new Group(13, groupCode13, 0, "IUST-2");
		Group group14 = new Group(14, groupCode14, 1, "IUST-2");
		...
		Group group82 = new Group(1, groupCode82, 1, "SMPR-1");
		...
		Group group92 = new Group(1, groupCode92, 1, "IUST-1");
		Group group93 = new Group(2, groupCode93, 0, "IUST-1");
		Group group94 = new Group(3, groupCode94, 1, "IUST-1");
		Group group95 = new Group(1, groupCode95, 0, "IUST-1");
		Group group96 = new Group(2, groupCode96, 1, "IUST-1");
		Group group97 = new Group(3, groupCode97, 0, "IUST-1");
		Group group98 = new Group(1, groupCode98, 1, "IUST-1");
		Group group99 = new Group(2, groupCode99, 0, "IUST-1");
		Group group100 = new Group(3, groupCode100, 1, "IUST-1");
		// PZS-1
